...
/**
 * @brief StrassensSquaredKernel class, implement C = A*B
...
gemmreadab_ldpatterns:
		t_subMatOps.ReadToBuffer_4x4(l_bAddr, l_aColBlock, l_bColBlock, l_bWordLd, buffer_b);
		t_subMatOps.ReadToBuffer_4x4(l_aAddr, l_aRowBlock, l_aColBlock, l_aWordLd, buffer_a);
		...
		t_subMatOps.AddBlocks_4(l_bAddr, buffer_b, 
				0, 0, 1, 
				1, 1, 1, 
				2, 2, 1, 
				3, 3, 1, 
				s_rhs);
		t_subMatOps.AddBlocks_4(l_aAddr, buffer_a, 
				0, 0, 1, 
				1, 1, 1, 
				2, 2, 1, 
				3, 3, 1, 
		...
		t_subMatOps.AddBlocks_4(l_bAddr, buffer_b, 
				...
				3, 3, 0, 
				s_rhs);
		t_subMatOps.AddBlocks_2(l_aAddr, buffer_a, 
				0, 0, 1, 
				2, 2, 1, 
				s_lhs);
		t_subMatOps.AddBlocks_4(l_bAddr, buffer_b, 
		...
		t_subMatOps.AddBlocks_4(l_aAddr, buffer_a, 
				...
				3, 3, 0, 
				s_lhs);
		t_subMatOps.AddBlocks_2(l_bAddr, buffer_b, 
				0, 0, 1, 
				2, 2, 1, 
				s_rhs);
		t_subMatOps.AddBlocks_4(l_aAddr, buffer_a, 
    ...
    void ClearBuffer(MemWideType p_buffer[4][4][t_aColMemWords*t_aMH]) {
#pragma HLS INLINE
