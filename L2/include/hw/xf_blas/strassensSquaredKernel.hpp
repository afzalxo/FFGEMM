...
/**
 * @brief StrassensSquaredKernel class, implement C = A*B using Strassen's squared algorithm, meaning that the
 * algorithm uses two levels of recursion and over the base case of 2x2 submatrices. It applies to submatrices of 
 * size 4x4. The algorithm is implemented using a tensor factor representation of the Strassen's squared algorithm.
...
gemmreadab_ldpatterns:
		...
		// the Strassen's one-level algorithm tensor factor representation with itself.
		t_subMatOps.AddBlocks_4(buffer_b, 
				0, 0, 1, 
				1, 1, 1, 
				2, 2, 1, 
				3, 3, 1, 
				s_rhs);
		t_subMatOps.AddBlocks_4(buffer_a, 
				0, 0, 1, 
				1, 1, 1, 
				2, 2, 1, 
				3, 3, 1, 
		...
		t_subMatOps.AddBlocks_4(buffer_b, 
				...
				3, 1, 0, 
				s_rhs);
		t_subMatOps.BufferToStream(buffer_a, 2, 2, s_lhs);
		t_subMatOps.AddBlocks_4(buffer_b, 
				1, 0, 0, 
				1, 1, 0, 
				3, 0, 1, 
		...
		t_subMatOps.AddBlocks_4(buffer_b, 
				...
				3, 0, 1, 
				s_rhs);
		t_subMatOps.BufferToStream(buffer_a, 3, 3, s_lhs);
		t_subMatOps.AddBlocks_4(buffer_b, 
				0, 0, 0, 
				0, 1, 0, 
				2, 0, 1, 
		...
		t_subMatOps.AddBlocks_4(buffer_a, 
				...
				1, 3, 0, 
				s_lhs);
		t_subMatOps.BufferToStream(buffer_b, 2, 2, s_rhs);
		t_subMatOps.AddBlocks_4(buffer_a, 
				1, 0, 1, 
				1, 1, 1, 
				1, 2, 1, 
		...
		t_subMatOps.AddBlocks_4(buffer_a, 
				...
				1, 2, 1, 
				s_lhs);
		t_subMatOps.BufferToStream(buffer_b, 3, 3, s_rhs);
		t_subMatOps.AddBlocks_4(buffer_a, 
				0, 0, 1, 
				0, 1, 1, 
				0, 2, 1, 
...
buffer_block_strassen_4_inner_blk_idx:
			...
			if (p_buffer2_sign) {
			   p_buffer2[buffer_dst_idx0+j][k] += l_val[k];
			} else {
			   p_buffer2[buffer_dst_idx0+j][k] -= l_val[k];
			}
			if (p_buffer3_sign) {
			   p_buffer3[buffer_dst_idx0+j][k] += l_val[k];
			} else {
			   p_buffer3[buffer_dst_idx0+j][k] -= l_val[k];
			}
		    }
...
out_buffer_inner1:
		...
		// Strassen's squared algorithm.
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 1, l_buffer[1][1], 1, l_buffer[2][2], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][1], 1, l_buffer[1][1], 1, l_buffer[2][3], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[0][0], 1, l_buffer[2][2], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[1][0], 1, l_buffer[1][1], 0, l_buffer[3][2], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 1, l_buffer[1][0], 1, l_buffer[2][2], 1, l_buffer[3][2], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[1][1], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 0, l_buffer[0][1], 1, l_buffer[2][2], 0, l_buffer[2][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][2], 1, l_buffer[1][3], 1, l_buffer[2][2], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][3], 1, l_buffer[1][3], 1, l_buffer[2][3], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[0][2], 1, l_buffer[2][2], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[1][2], 1, l_buffer[1][3], 0, l_buffer[3][2], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[0][2], 1, l_buffer[1][2], 1, l_buffer[2][2], 1, l_buffer[3][2], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[1][3], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][2], 0, l_buffer[0][3], 1, l_buffer[2][2], 0, l_buffer[2][3], 1);
		...
		BufferBlockStrassen_4(p_istream, l_buffer[2][0], 1, l_buffer[2][2], 0, l_buffer[3][1], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[2][1], 1, l_buffer[2][3], 0, l_buffer[3][1], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_2(p_istream, l_buffer[2][0], 1, l_buffer[2][2], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[3][0], 1, l_buffer[3][1], 0, l_buffer[3][2], 0, l_buffer[3][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[2][0], 1, l_buffer[2][2], 0, l_buffer[3][0], 1, l_buffer[3][2], 0);
		BufferBlockStrassen_2(p_istream, l_buffer[3][1], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[2][0], 0, l_buffer[2][1], 1, l_buffer[2][2], 1, l_buffer[2][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 1, l_buffer[1][1], 1, l_buffer[2][0], 1, l_buffer[3][1], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][1], 1, l_buffer[1][1], 1, l_buffer[2][1], 1, l_buffer[3][1], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[0][0], 1, l_buffer[2][0], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[1][0], 1, l_buffer[1][1], 0, l_buffer[3][0], 1, l_buffer[3][1], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 1, l_buffer[1][0], 1, l_buffer[2][0], 1, l_buffer[3][0], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[1][1], 1, l_buffer[3][1], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 0, l_buffer[0][1], 1, l_buffer[2][0], 0, l_buffer[2][1], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[2][2], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[2][3], 1, l_buffer[3][3], 1);
		BufferBlockStrassen_1(p_istream, l_buffer[2][2], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[3][2], 1, l_buffer[3][3], 0);
		BufferBlockStrassen_2(p_istream, l_buffer[2][2], 1, l_buffer[3][2], 1);
		BufferBlockStrassen_1(p_istream, l_buffer[3][3], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[2][2], 0, l_buffer[2][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 0, l_buffer[0][2], 1, l_buffer[1][1], 0, l_buffer[1][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][1], 0, l_buffer[0][3], 1, l_buffer[1][1], 0, l_buffer[1][3], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[0][0], 0, l_buffer[0][2], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[1][0], 0, l_buffer[1][1], 1, l_buffer[1][2], 1, l_buffer[1][3], 0);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 0, l_buffer[0][2], 1, l_buffer[1][0], 0, l_buffer[1][2], 1);
		BufferBlockStrassen_2(p_istream, l_buffer[1][1], 0, l_buffer[1][3], 1);
		BufferBlockStrassen_4(p_istream, l_buffer[0][0], 1, l_buffer[0][1], 0, l_buffer[0][2], 0, l_buffer[0][3], 1);
	    }
