...
typedef KargsType::MemFloatType MemFloatType;
typedef xf::blas::ControlArgs ControlArgsType;

typedef xf::blas::MemMatrixShape MemMatrixShapeType;
typedef MemMatrixShapeType::FormatType MatFormatType;
...
class Program {
   ...
   public:
    ...
    MemFloatType* getBaseInstrAddr() { return (MemFloatType*)&m_PageVector[BLAS_codePage]; }
    MemFloatType* getBaseResAddr() { return (MemFloatType*)&m_PageVector[BLAS_resPage]; }
    MemFloatType* addInstr() {
        ...
        MemFloatType* l_instrAdd = (MemFloatType*)&l_instrBased[m_NumInstr];
        ++m_NumInstr;
        return (l_instrAdd);
    }
