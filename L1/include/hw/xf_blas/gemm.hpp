...
#pragma HLS DATAFLOW
    ...
    Gemm<t_DataType, t_KBufferDim, t_ParEntries, t_ParEntries>::gemm(p_A, p_B, l_sum, l_blocks); // p_A * p_B
    gemmBufferC<t_DataType, t_ParEntries, t_ParEntries, t_MaxSizeC>(p_m, p_n, l_sum, p_R);
}
