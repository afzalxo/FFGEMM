...
from operation import OP, BLAS_L1, BLAS_L2, BLAS_L3, OP_ERROR
...
class RunTest:
    ...
    def runTest(self):
        ...
        print(
            "\nOP %s: Data file %s has been generated sucessfully using shared library." %
