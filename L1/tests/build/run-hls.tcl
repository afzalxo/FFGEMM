...
# vitis_hls -f ./build/run-hls.tcl tests out_test/gemm/data/prameters_<>.tcl out_test/gemm/directive_par<>.tcl out_test/gemm/data/TestBin_<>.bin
####################
set pwd [pwd]
set pid [pid]
